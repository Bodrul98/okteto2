...
pwd
pwd
wget -O config.env https://gist.githubusercontent.com/Bodrul98/9f822538053e9511d296363fa65228bd/raw/config.env
wget -O token.pickle https://github.com/Bodrul98/okteto2/raw/main/token.pickle
rin
bash start*
}
dl
